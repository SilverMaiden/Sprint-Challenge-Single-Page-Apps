...
While it may take longer to initially load the web application, once it has loaded, routing between different views of the application becomes faster, and transitions become smoother.
